...
public class OpenTransmutationPacket {
    public OpenTransmutationPacket() {
    }

    public OpenTransmutationPacket(FriendlyByteBuf buf) {
    }
    ...
    public boolean handle(Supplier<NetworkEvent.Context> ctxSupplier) {
        ...
        ctx.enqueueWork(() -> ServerPacketHandlers.handleOpenTransmutation(ctx.getSender()));
